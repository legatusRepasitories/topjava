...
public class MealServlet extends HttpServlet {
    ...
    ConfigurableApplicationContext appCtx = SpringMain.getContext();
...
//                repository.delete(id, SecurityUtil.authUserId());
            ...
            default:
                ...
                request.setAttribute("meals",
                        MealsUtil.getWithExcess(mealRestController.getAll(SecurityUtil.authUserId()), MealsUtil.DEFAULT_CALORIES_PER_DAY));
